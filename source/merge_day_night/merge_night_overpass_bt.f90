...
dir='/data/VIIRS_GLOBAL_PROCESS/tiles/'
do k = 1, nfiles
 write(lstfile,'(a,a,a,I7,a,a,a)') trim(dir),arg4,'/night_bt_flag_',yyyyddd,'_',times(k),'.dat' 
 write(viewfile,'(a,a,a,I7,a,a,a)') trim(dir),arg4,'/view_angle_',yyyyddd,'_',times(k),'.dat'
...
write(6,*) final_lst(2500,1500), final_view(2500,1500)
 ...
 write(lstfile,'(a,a,a,I7,a)') trim(dir),arg4,'/FINAL_NIGHT_BT_',yyyyddd,'.dat'
 open(10,file=lstfile,form='unformatted',access='direct',recl=dx*dy*4)
