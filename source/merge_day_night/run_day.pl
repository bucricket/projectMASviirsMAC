...
$yyyyddd=$year*1000+$doy;
 print "$yyyyddd\n";
 @files=`ls $tiledir/${tile_num}/day_bt_flag_${yyyyddd}_$tile_num*`;
 ...
 # Run Merge Code
 `$homedir/merge_day_overpass $homedir/lst_files_${tile_num}.txt $year $doy $tile_num $nfiles`;
 `gzip -ff $tiledir/${tile_num}/FINAL_DAY_LST_${yyyyddd}_${tile_num}.dat`;
 `gzip -ff $tiledir/${tile_num}/FINAL_DAY_VIEW_${yyyyddd}_${tile_num}.dat`;
